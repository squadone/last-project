...
After running `npm run serve` **in the `ui.frontend` directory**, your app will be automatically opened in your browser (at path http://localhost:8000/content/wknd-spa-vue/us/en/home.html). If you make edits, the page will reload.
